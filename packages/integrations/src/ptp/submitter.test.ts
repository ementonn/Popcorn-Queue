...
describe("PtpFormSubmitter", () => {
  it("posts an add-format upload with editable review draft fields", async () => {
    ...
    expect(form.get("imdb")).toBeNull();
    expect(form.get("title")).toBeNull();
    expect(form.get("year")).toBeNull();
    expect(form.get("image")).toBeNull();
    expect(form.get("trailer")).toBeNull();
    expect(form.get("tags")).toBeNull();
    expect(form.get("album_desc")).toBeNull();
    expect(form.get("uploadtoken")).toBeNull();
    expect(form.getAll("artist[]")).toEqual([]);
    expect(form.getAll("importance[]")).toEqual([]);
